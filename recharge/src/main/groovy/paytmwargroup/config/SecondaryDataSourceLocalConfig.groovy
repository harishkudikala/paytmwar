package paytmwargroup.config

import paytmwargroup.common.constant.SpringProfile
...
@PropertySource('file:${SPRING_BOOT_PROPERTIES_DIR}/recharge.properties')
class SecondaryDataSourceLocalConfig extends SecondaryDataSourceAbstractConfig {
    ...
    SecondaryDataSourceLocalConfig() {
        ...
        assert Files.exists(Paths.get("${dir}/recharge.properties")),
                "${dir}/recharge.properties containing externalized datasource properties must exist"
    }
